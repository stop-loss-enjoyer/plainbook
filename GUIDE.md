...
1. **Opened a position — write it down at once.** The **+ Trade** button.
2. **Closed the position — close the trade.** The **Close** button in the open
...
- **process grade** and **opportunity quality** — the suggestion offers
  A / B / C / D / F, but the field is free: write in whatever scale you use.
...
- **Filters** — the funnel button to the left of the switch: account, pair,
...
- **Pairs** are the suggestions for the form. Taking a pair out of the list does
  not touch the trades already recorded with it.
...
and **never overwrites your conclusions** — you can write them right in the
report.
